...
const canvas = document.querySelector("#Layer1") as HTMLCanvasElement;
...
const upBtn = document.getElementById("top") as HTMLButtonElement;
const downBtn = document.getElementById("down") as HTMLButtonElement;
const resetBtn = document.getElementById("rest") as HTMLButtonElement;
...
const smoothing = 0.2;
const placementStore = new Map<SVGGElement, Placement>();
...
// DRAW HELPERS
// =====================
function drawSmoothLine(xRaw: number, yRaw: number): void {
...
// SVG RENDERING
// =====================
function drawSVG(path: string, color: string, size: number): void {
  ...
  pathEl.setAttribute("stroke-width", String(size));
...
// MOVE SYSTEM
// =====================
function updatePosition(dx: number, dy: number): void {
  document.querySelectorAll<SVGGElement>("g").forEach((el) => {
...
// CONTROLS
// =====================
function startMove(dx: number, dy: number): void {
